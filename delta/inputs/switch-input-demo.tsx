...
export default function SwitchInputDemo() {
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8 space-y-12">
      <h1 className="text-3xl font-bold mb-8 text-center">Custom Switch Input Demo</h1>
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground mb-4">
        The extended click area creates an invisible touch target around the switch, making it easier to interact with,
        especially on mobile devices. The dotted border below visualizes the extended area (not visible in production).
      </p>
      ...
      <div className="mt-4 p-4 bg-muted/50 rounded-lg">
        <p className="text-sm text-muted-foreground">
          <strong>Note:</strong> The extended click area is enabled by default for better mobile usability. It creates a
          larger touch target (approximately 40px in each direction) without changing the visual appearance. Try
          tapping/clicking near the switch in the first example - it will toggle even when clicking outside the visible
          switch.
        </p>
      </div>
    </div>
...
export function VariantsDemo() {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <SwitchInput label="Pill" name="pill-variant" variant="pill" defaultChecked />
        <SwitchInput label="Rectangular (Default)" name="rectangular-variant" variant="rectangular" defaultChecked />
        <SwitchInput label="Large Pill" name="large-pill" variant="pill" size="large" defaultChecked />
        <SwitchInput
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <SwitchInput label="Large Size (1.2x)" name="large-size" size="large" defaultChecked />
      </div>
    </div>
  )
}
...
export function CustomColorSwitch() {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <SwitchInput label="Success" name="success-switch" activeColor="#22c55e" defaultChecked />
        <SwitchInput label="Warning" name="warning-switch" activeColor="#f59e0b" defaultChecked />
        <SwitchInput label="Info" name="info-switch" activeColor="#3b82f6" defaultChecked />
        <SwitchInput label="Danger" name="danger-switch" activeColor="#ef4444" defaultChecked />
        <SwitchInput
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <SwitchInput label="Notifications" name="notifications" defaultChecked variant="pill" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <SwitchInput label="Sound Effects" name="sound-effects" labelVariant="muted" defaultChecked />
      </div>
    </div>
  )
}
...
export function RequiredSwitchInputDemo() {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <SwitchInput label="Accept Privacy Policy" name="privacy-policy" required />
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <SwitchInput label="System Setting" name="system-setting" disabled defaultChecked />
      </div>
    </div>
  )
}
