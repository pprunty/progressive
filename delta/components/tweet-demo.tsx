    ...
    <div className="space-y-8 flex flex-col items-center">
      <div className="w-full max-w-2xl">
        ...
        <p className="text-sm text-muted-foreground mt-2 text-center">
          Small tweets are more compact and work well on both mobile and
          desktop.
        </p>
      </div>
      ...
      <div className="w-full max-w-2xl">
        <h2 className="text-xl font-semibold mb-2">
          Multiple Tweets Including Media
        </h2>
        ...
        <p className="text-sm text-muted-foreground mt-2 text-center">
          Note: Standard-sized tweets use default, responsive size on desktop
          but may require horizontal scrolling on mobile devices, depending on
          parent container.
        </p>
      </div>
    </div>
