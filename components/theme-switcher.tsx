  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex rounded-md border border-border bg-background hover:bg-accent hover:text-accent-foreground transition-[background-color]  p-2 theme-system:!bg-inherit [&_.sun-icon]:hidden dark:[&_.moon-icon]:hidden dark:[&_.sun-icon]:inline"
        onClick={(ev) => {
          ev.preventDefault();
